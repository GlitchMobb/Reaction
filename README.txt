...
4. User Enter a list of emails to send survey to (React + Redux + Redux Form)

5. We Send email to list of surveyees (React + Redux + Redux Form)

6. Surveyees click on link in email to provide feedback (Email Provider)
